	...
	public void buildMenu() {
		...
		registerStartingAction(new MenuFunction() {
			...
			public void selected() {
				getMemoryModel().render(list.getClass(), new LinkedListRenderer<String>(true, false, LocalAnimation.algae()));
				globalVar("list", list);
		...
		register ("find", new MenuFunction() {
			@Override
			public void selected() {
				ActivationRecord arec = LocalAnimation.activate(getClass());
