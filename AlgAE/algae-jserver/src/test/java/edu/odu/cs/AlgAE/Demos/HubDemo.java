...
public class HubDemo extends LocalJavaAnimation {
	...
	public class Hub implements CanBeRendered<Hub>, Renderer<Hub> {
		...
		public void add (Hub h, int len, double angle)
		{
			...
			lengths.add (len);
			angles.add (angle);
			ActivationRecord arec = LocalJavaAnimation.activate(center);
		...
		public void clear ()
		{
			...
			lengths.clear();
			angles.clear();
			ActivationRecord arec = LocalJavaAnimation.activate(this);
	...
	public void buildMenu() {
		...
		register ("clear", new MenuFunction() {
			@Override
			public void selected() {
				LocalJavaAnimation.activate(center).breakHere("clear1");
				center.clear();
				LocalJavaAnimation.activate(center).breakHere("clear2");
			}
		});
