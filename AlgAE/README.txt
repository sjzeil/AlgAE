...
Build path info:
   ...
   - For the default output folder, use the project's own src directory.
     ...
     source code, a relationship required if animations are to find and display
     their source code while running.
...
assume that they have been deplyed into the same directory as their
