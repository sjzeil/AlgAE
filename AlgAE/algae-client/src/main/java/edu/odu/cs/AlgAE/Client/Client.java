 ...
 * the Java Applet lifecycle functions.  These are assumed to follow the usual Applet ordering constraints
...
public interface Client {
	 ...
	 */
	public abstract ServerProxy getServerProxy();
	 ...
	 */
	public abstract void setServerProxy(ServerProxy server);
