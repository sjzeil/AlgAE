...
public class SortingDriver4 extends LocalJavaAnimationApplet {

	public SortingDriver4() {
	...
	public void buildMenu() {
		...
		register ("Bubble Sort", new MenuFunction() {
			@Override
			public void selected() {
				Sorting4.bubbleSort (array, array.length);
			}
		});
		...
		register ("Selection Sort", new MenuFunction() {
			@Override
			public void selected() {
				Sorting4.selectionSort (array, array.length);
			}
		});
		...
		register ("Insertion Sort", new MenuFunction() {
			@Override
			public void selected() {
				Sorting4.insertionSort (array, array.length);
			}
		});
	...
	public static void main (String[] args) {
		SortingDriver4 demo = new SortingDriver4();
		demo.runAsMain();
	}
